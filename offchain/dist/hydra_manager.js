...
exports.hydraManager = exports.HydraManager = void 0;
class HydraManager {
    ...
    updateStatus(headStatus) {
        ...
        if (headStatus.tag === 'Idle')
            this.status = 'Idle';
        else if (headStatus.tag === 'Initializing')
            this.status = 'Initializing';
        else if (headStatus.tag === 'Open')
            this.status = 'Open';
        else if (headStatus.tag === 'Closed')
            this.status = 'Closed';
        else
            this.status = 'Idle'; // Default
        this.emit('statusChanged', this.status);
    }
    /**
...
exports.HydraManager = HydraManager;
// Export singleton for simple usage, but class is also exported
exports.hydraManager = new HydraManager();
